...
ItemTag.create(item_id: 4, tag_id: 106 )
ItemTag.create(item_id: 4, tag_id: 10 )
ItemTag.create(item_id: 4, tag_id: 65 )
ItemTag.create(item_id: 4, tag_id: 114 )

ItemTag.create(item_id: 5, tag_id: 7 )
ItemTag.create(item_id: 5, tag_id: 65 )
ItemTag.create(item_id: 5, tag_id: 106 )
ItemTag.create(item_id: 5, tag_id: 108 )
